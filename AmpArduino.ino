...
const float biasResistor = 0.47;                    // value of bias resistor in Ohm 
const int biasMultiplier = 2;                       // multiplier of bias resistor  
...
void setup() {   // Setup
  ...
  corBias =  biasMultiplier * (corOffset/biasResistor);      // multiply if setup of ammp requires it 
